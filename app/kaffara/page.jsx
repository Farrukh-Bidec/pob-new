...
export async function generateMetadata() {
  ...
  const kaffaraData = await fetchData({ url: "kaffara-page/show-data", slug: "kaffara/" });
  ...
  return {
    ...
    alternates: { canonical: `https://pobtrust.com${kaffaraData?.pagesSeoDetail?.canonical_url}` },
    openGraph: {
      title: kaffaraData?.pagesSeoDetail?.meta_title,
      description: kaffaraData?.pagesSeoDetail?.meta_description,
      type: "website",
      images: kaffaraData?.pagesSeoDetail?.meta_image
        ? [
          {
            url: `https://pobtrust.com${kaffaraData.pagesSeoDetail.meta_image}`,
            width: 1200,
            height: 630,
            alt: kaffaraData?.pagesSeoDetail?.meta_title || "Kaffara Image",
          },
        ]
        : [],
    },
    twitter: {
      ...
      description: kaffaraData?.pagesSeoDetail?.meta_description,
      images: kaffaraData?.pagesSeoDetail?.meta_image
        ? [`https://pobtrust.com${kaffaraData.pagesSeoDetail.meta_image}`]
        : [],
    },
...
export default async function KaffaraPage() {
  ...
  return (
    <div className="pt-20 md:pt-32">
      ...
      <ArabicVerse
        img01="/kaffaraVerse.webp"
        img02="/kaffaraVerse.webp"
