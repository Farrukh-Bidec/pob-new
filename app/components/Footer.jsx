...
const Footer = () => {
    ...
    const servicesLinks = [{
        ...
        "url": "https://pob-delta.vercel.app/cataract-extractions/"
    },
    {
        "name": "Vitroretina",
        "url": "https://pob-delta.vercel.app/vitreoretina/"
    },
    {
        "name": "Laser Treatments",
        "url": "https://pob-delta.vercel.app/laser-treatments/"
    },
    {
        "name": "Diabetic Eye Care",
        "url": "https://pob-delta.vercel.app/diabetic-eye-care/"
    },
    {
        "name": "General Ophthalmology Screening Clinic",
        "url": "https://pob-delta.vercel.app/general-ophthalmology-screening-clinic/"
    },
    {
        "name": "Neuro-Ophthalmology",
        "url": "https://pob-delta.vercel.app/neuro-ophthalmology/"
    },
    {
        "name": "Pediatric Eye Care Service",
        "url": "https://pob-delta.vercel.app/pediatric-eye-care/"
    }
    ];
    const servicesLinks2 = [
        {
            "name": "Corneal Diseases",
            "url": "https://pob-delta.vercel.app/corneal-diseases/"
        },
        {
            "name": "Glaucoma",
            "url": "https://pob-delta.vercel.app/glaucoma/"
        },
        {
            "name": "Oculoplasty & Orbit",
            "url": "https://pob-delta.vercel.app/oculoplasty-and-orbit/"
        },
        {
            "name": "Diagnostic Services",
            "url": "https://pob-delta.vercel.app/diagnostic-services/"
        },
        {
            "name": "Optometry Care",
            "url": "https://pob-delta.vercel.app/optometry-care/"
        },
        {
            "name": "Medical Retina",
            "url": "https://pob-delta.vercel.app/medical-surgical-retina/"
        }
    ]
    const contactLinks = [
        {
            name: "About Us",
            url: "https://pob-delta.vercel.app/about-us/"
        },
        {
            name: "Contact Us",
            url: "https://pob-delta.vercel.app/contact-us/"
        },
        {
            name: "Privacy Policy",
            url: "https://pob-delta.vercel.app/privacy-policy/"
        },
        {
            name: "Terms & Conditions",
            url: "https://pob-delta.vercel.app/terms-conditions/"
        }
    ];
                ...
                >
                    ...
                    <div className="md:w-[70%] w-full min-h-[200px] md:h-[100%]">
                        ...
                        <div className="md:hidden text-white">
                            ...
                            {isGetInvolvedOpen && (
                                <ul className="flex flex-col gap-2 py-3 text-sm">
                                    <Link href={"https://pob-delta.vercel.app/donation/"} className="hover:text-[#F39C12]">
                                        Donate Now
                                    </Link>
                                    <Link href={"https://pob-delta.vercel.app/volunteer/"} className="hover:text-[#F39C12]">
                                        Volunteer With Us
                                    </Link>
                                    <Link href={"https://pob-delta.vercel.app/zakat/"} className="hover:text-[#F39C12]">
                        ...
                        <div className="md:hidden text-white">
                            ...
                            {isResourcesOpen && (
                                <ul className="flex flex-col gap-2 py-3 text-sm">
                                    <Link href={"https://pob-delta.vercel.app/blog/"} className="hover:text-[#F39C12]">
                                        Blogs
                                    </Link>
                                    <Link href={"https://pob-delta.vercel.app/annual-reports/"} className="hover:text-[#F39C12]">
