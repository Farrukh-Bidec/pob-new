...
export async function generateMetadata() {
  ...
  const sadaqahData = await fetchData({ url: "sadaqah-page/show-data", slug: "sadaqah/" });
  ...
  return {
    ...
    alternates: { canonical: `https://pobtrust.com${sadaqahData?.pagesSeoDetail?.canonical_url}` },
    openGraph: {
      title: sadaqahData?.pagesSeoDetail?.meta_title,
      description: sadaqahData?.pagesSeoDetail?.meta_description,
      type: "website",
      images: sadaqahData?.pagesSeoDetail?.meta_image
        ? [
          {
            url: `https://pobtrust.com${sadaqahData.pagesSeoDetail.meta_image}`,
            width: 1200,
            height: 630,
            alt: sadaqahData?.pagesSeoDetail?.meta_title || "Sadaqah Image",
          },
        ]
        : [],
    },
    twitter: {
      ...
      description: sadaqahData?.pagesSeoDetail?.meta_description,
      images: sadaqahData?.pagesSeoDetail?.meta_image
        ? [`https://pobtrust.com${sadaqahData.pagesSeoDetail.meta_image}`]
        : [],
    },
...
export default async function SadaqahPage() {
  ...
  return (
    <div className="pt-20 md:pt-32">
      ...
      <ArabicVerse
        img01="/sadaqahverse.webp"
        img02="/arabicVerse2.webp"
