...
const KaffaraTypes = ({ section_3 }) => {
  ...
  //     ],
  //     image: "fast.webp", // Replace with actual image path
  //   },
  //   {
  ...
  //       "Fast for three days."
  //     ],
  //     image: "oath.webp", // Replace with actual image path
  //   },
  //   {
  ...
  //     ],
  //     image: "vow.webp", // Replace with actual image path
  //   },
  // ];
          ...
          <div key={index} className="bg-white p-6 rounded-lg text-left">
            <div className="bg-[#28A745] p-2 w-fit h-fit rounded-lg mx-auto md:mx-0">
              <img
                ...
                alt={item?.alt_text || item?.image_alt_text || item?.heading || "Kaffara Type"}
