    ...
    <section className="bg-gray-100 py-10">
      <div className="w-full max-w-[95%] mx-auto flex flex-col md:flex-row gap-6 items-start md:items-center px-4 sm:px-6 md:px-12 lg:px-24">
        ...
        <div className="flex-1 min-w-0 text-center md:text-left">
          <div className="">
            <p className="text-yellow-500 uppercase text-lg tracking-wider font-Amaranth font-bold">
              Media Gallery
            </p>
            ...
            <Link href="https://www.pobtrust.com/gallery/" title="Explore POB Trust’s gallery of restored sight and charity events">
