      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-8">
          ...
          <div className="flex flex-col gap-4">
            <div className="mx-auto md:mx-0 w-fit px-1 pt-2 rounded-full bg-[#F39C12]">
              <img
                ...
                alt={options[0]?.alt_text || options[0]?.heading || "Waqf Option"}
          ...
          <div className="flex flex-col gap-4">
            <div className="mx-auto md:mx-0 w-fit px-1 py-1 rounded-full bg-[#F39C12]">
              <img
                ...
                alt={options[1]?.alt_text || options[1]?.heading || "Waqf Option"}
                className="w-10 h-10 rounded-full object-cover"
              />
            </div>
            <div className="text-center md:text-start">
        ...
        <div className="w-full md:w-1/3 flex justify-center">
          <img
            ...
            alt={section_4?.alt_text || section_4_heading || "Main Impact"}
          ...
          <div className="flex flex-col gap-4">
            <div className="mx-auto md:mx-0 w-fit px-1 py-1 rounded-full bg-[#F39C12]">
              <img
                ...
                alt={options[2]?.alt_text || options[2]?.heading || "Waqf Option"}
                className="w-10 h-10 rounded-full object-cover"
              />
            </div>
            <div className="text-center md:text-start">
          ...
          <div className="flex flex-col gap-4">
            <div className="mx-auto md:mx-0 w-fit px-1 py-1 rounded-full bg-[#F39C12]">
              <img
                ...
                alt={options[3]?.alt_text || options[3]?.heading || "Waqf Option"}
                className="w-10 h-10 rounded-full object-cover"
              />
            </div>
            <div className="text-center md:text-start">
