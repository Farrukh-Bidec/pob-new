  ...
  return (
    <section className="w-full text-sm px-6 md:px-20 py-10 flex flex-col md:flex-row items-center gap-10">
      ...
      <div className="md:w-1/2 text-center md:text-start">
        <h3 className="text-[#F39C12] font-Amaranth text-lg uppercase text-center md:text-start font-bold">
          {yellowHead}
        </h3>
        ...
        {pageName === "donation" ? (
          ...
          <p
            className="text-sm font-inter text-[#777777] font-medium"
