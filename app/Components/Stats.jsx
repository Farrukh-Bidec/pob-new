...
//   <div className="text-2xl md:text-4xl 2xl:text-[60px] font-antonio font-[550] pt-6 relative">
//     <img
//       src="circle.png"
//       alt="labels"
//       className="absolute 2xl:-ml-6 md:-ml-4 op  2xl:mt-2  left2 sm:left-0 w-6 h-6 md:w-12 md:h-12 2xl:w-16 2xl:h-16"
//     />
//     {stat.number}
//   </div>
//   <div className="text-xs md:text-[16px] text-gray-700 mt-4">
