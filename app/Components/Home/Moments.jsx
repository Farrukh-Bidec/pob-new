...
const Moments = () => {
  const images = [
    {
      img: "/img1.webp",
      alt: "A group of people gathered around a man speaking and explaining something, possibly in a community or healthcare setting."
    },
    {
      img: "/img2.webp",
    },
    ...
    <div className="pt-12 w-full">
      <div className=" flex  justify-center flex-col gap-4    items-center  ">
        <div className=" flex flex-col text-center md:text-center justify-center   ">
          <p className=" uppercase text-[#F39C12] text-lg font-Amaranth font-bold ">Our Story</p>
        ...
        <div className=" grid grid-cols-1 md:grid-cols-4 gap-4 flex-wrap    justify-center  w-[89%]  ">
          {images.slice(0, visibleImages).map((element, index) => (
            ...
            <img
              key={index}
              src={element.img}
              alt={element.alt_text || element.alt || "POB Trust Moment"}
        ...
        <div className=" flex justify-center gap-2 ">
          ...
          <a
            href="https://www.instagram.com/pobeyehospitalkarachi/pobeyehospitalkarachipobeyehospitalkarachi
pobeyehospitalkarachi/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <button className=" flex gap-2 text-[15px] items-center  rounded-[37px] bg-[#28A745] text-white font-bold px-4 py-2  cursor-pointer shadow-sm   ">
              <span>
