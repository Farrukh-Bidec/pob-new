            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-8">
                ...
                <div className="space-y-8 w-full md:w-1/3">
                    <div className="flex flex-col justify-center md:justify-start gap-4">
                        ...
                        <div
                            className="text-gray-600 text-lg text-center md:text-start font-inter"
                ...
                <div className="w-full md:w-1/3 flex justify-center">
                    <img
                        ...
                        alt={section_2?.alt_text || zakat_who_qualify_heading || "Main Impact"}
                ...
                {/* Right Side Content */}
                <div className="space-y-8 w-full md:w-1/3">
                    <div className="flex flex-col gap-4 justify-center md:justify-end md:items-end">
                        <div className="w-fit px-1 py-1 rounded-full bg-[#F39C12] md:mx-0 mx-auto">
                            <img
                                src={`${Image_Url}/${cards[2]?.images}`}
                                alt={cards[2]?.alt_text || cards[2]?.heading || "Waqf Option"}
                                className="w-10 h-10 rounded-full object-cover"
                            />
                        </div>

                        <div
                            className="text-gray-600 text-lg text-center md:text-end font-inter"
                            dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(cards[2]?.descriptions) }}
                        ></div>
                    </div>
                    <div className="flex flex-col gap-4 justify-center md:justify-start md:items-end">
                        <div className="w-fit px-1 py-1 rounded-full bg-[#F39C12] md:mx-0 mx-auto">
                            <img
                                src={`${Image_Url}/${cards[3]?.images}`}
                                alt={cards[3]?.alt_text || cards[3]?.heading || "Waqf Option"}
                                className="w-10 h-10 rounded-full object-cover"
                            />
                        </div>
                        <div
