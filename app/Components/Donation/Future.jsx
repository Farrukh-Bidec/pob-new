      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full lg:w-2/3 font-inter">
        <div className="flex items-start space-x-4 group">
          <div className="group-hover:bg-[#28A745] border  border-[#28A745] text-white p-3 rounded-full ">
            <img
              ...
              src="/futureImgwhite1.webp"
              alt="Icon representing the exchange of money or a financial transaction."
            />
            <img
              className="group-hover:hidden block w-16"
              src="/futureImgBlack1.webp"
              alt="Icon representing a user or person profile."
            />
          </div>
          <div>
        ...
        <div className="flex items-start space-x-4 group">
          <div className="group-hover:bg-[#28A745] border  border-[#28A745] text-white p-3 rounded-full ">
            <img
              className="group-hover:block hidden w-16"
              src="/futureImgwhite2.webp"
              alt="Icon representing a tax document or tax filing"
            />
            <img
              className="group-hover:hidden block w-16"
              src="/futureImgBlack2.webp"
              alt="Icon representing a tax document or tax filing"
            />
          </div>
          <div>
        ...
        <div className="flex items-start space-x-4 group">
          <div className="group-hover:bg-[#28A745] border  border-[#28A745] text-white p-3 rounded-full ">
            <img
              className="group-hover:block hidden w-16"
              src="/futureImgwhite3.webp"
              alt="Icon representing a fast-moving stopwatch or timer."
            />
            <img
              className="group-hover:hidden block w-16"
              src="/futureImgBlack3.webp"
              alt="Icon representing a person or user profile."
            />
          </div>
          <div>
        ...
        <div className="flex items-start space-x-4 group">
          <div className="group-hover:bg-[#28A745] border  border-[#28A745] text-white p-3 rounded-full ">
            <img
              className="group-hover:block hidden w-16"
              src="/futureImgwhite4.webp"
              alt="Icon representing a file or document."
            />
            <img
              className="group-hover:hidden block w-16"
              src="/futureImgBlack4.webp"
              alt="Icon representing a file or document."
            />
          </div>
          <div>
