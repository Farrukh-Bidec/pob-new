  ...
  return (
    <div className="flex flex-col md:flex-row min-w-full pt-12 gap-4 items-center justify-center">
      ...
      <div className="md:w-5/12 w-[90%] font-inter items-center md:items-start flex flex-col gap-2">
        ...
        <Link href="https://www.pobtrust.com/corneal-diseases/" title="Learn More About Corneal Diseases and Treatments">
      ...
      <div>
        <Image
          src="/servicelist3.webp"
          width={450}
          height={450}
          alt="Eye doctor conducting an eye examination using a slit lamp on a patient."
