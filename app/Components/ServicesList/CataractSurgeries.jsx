  ...
  const data = [
    {
      ...
      img01: "/cataractpoint1.webp",
      img02: "/cataractpointwhite1.webp",
    },
    {
      ...
      img01: "/cataractpoint2.webp",
      img02: "/cataractpointwhite2.webp",
    },
    {
      ...
      img01: "/cataractpoint3.webp",
      img02: "/cataractpointwhite3.webp",
    },
    {
      ...
      img01: "/cataractpoint4.webp",
      img02: "/cataractpointwhite4.webp",
    },
  ];
  ...
  return (
    <div className="flex flex-col md:flex-row min-w-full pt-12 gap-4 items-center justify-center">
      <div className="md:w-5/12 w-[90%] font-inter items-center md:items-start flex flex-col gap-2">
        ...
        <Link href="https://www.pobtrust.com/oculoplasty-and-orbit/" title="Learn More About Oculoplasty and Orbit Services">
      ...
      <div>
        <Image
          src="/CataractImg.webp"
          width={450}
          height={450}
          className="md:h-[450px] md:w-[450px] h-[280px] w-[280px] rounded-full"
          alt="Close-up of an elderly man smiling while undergoing an eye examination with a light focused on his eye."
        />
      </div>
    </div>
  );
