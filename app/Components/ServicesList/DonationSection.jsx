  ...
  return (
    <div className="flex flex-col md:flex-row min-w-full pt-12 gap-4 items-center justify-center">
      <div className="md:w-5/12 w-[90%] font-inter items-center md:items-start flex flex-col gap-2">
        ...
        <Link  href="https://www.pobtrust.com/diagnostic-services/" title="Learn More About Diagnostic Services">
      ...
      <div>
        <Image
          ...
          alt="Doctor examining a child's eye using a light to check for any issues."
        />
      </div>
    </div>
  );
