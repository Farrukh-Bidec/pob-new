  ...
  return (
    <div className="flex flex-col md:flex-row min-w-full pt-12 gap-4 items-center justify-center">
      <div className="md:w-5/12 w-[90%] font-inter items-center md:items-start flex flex-col gap-2">
        ...
        <Link href="https://www.pobtrust.com/optometry-care/" title="Learn More About Optometry Care Services">
          <button
      ...
      <div>
        <Image
          ...
          alt="Doctor performing an eye examination on a woman wearing a headscarf using a specialized magnifying tool"
        />
      </div>
    </div>
  );
