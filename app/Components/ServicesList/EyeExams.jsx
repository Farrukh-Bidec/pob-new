    ...
    <div className="flex flex-col md:flex-row min-w-full pt-12 gap-4 items-center justify-center">
      <div>
        <Image
          ...
          alt="Person undergoing an eye test with a trial frame and lenses being adjusted."
        />
      </div>
      <div className="md:w-5/12 w-[90%] font-inter items-center md:items-start flex flex-col gap-2">
        ...
        <Link href="https://www.pobtrust.com/general-ophthalmology-screening-clinic/" title="Learn More About General Ophthalmology Screening Clinic" >
