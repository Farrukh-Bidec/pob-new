    ...
    <div id="home" className="pt-12 w-full">
      <div className="flex flex-col items-center h-full px-10 md:px-20">
        <div className="text-center py-8">
          <h3 className="uppercase text-[#F39C12] text-lg font-Amaranth font-bold">
            Reviews
          </h3>
              ...
              <SwiperSlide key={index}>
                <div className="flex w-full flex-col rounded-[10px] bg-[#F0F1F1] justify-center md:justify-start items-start">
                  <div className="h-auto md:h-[300px] px-4 py-4 md:px-8 text-center md:text-start md:py-8">
                    ...
                    <p className="text-[#838383] text-[15px] mb-6 font-inter font-medium leading-relaxed">
                      {testimonial.quote}
                    </p>
                  </div>
                  <div className="flex items-center bg-white w-full justify-start">
                    <div className="md:ml-8 pt-4 w-full">
                      <p className="text-lg text-center md:text-start font-inter">
                        {testimonial.name}
                      </p>
                    </div>
                  </div>
        ...
        <div className="mt-6 mb-4 flex gap-4">
          <button className="prev border-[#B3B3B3] border text-[#B3B3B3] p-2 rounded-full cursor-pointer" aria-label="Go to previous card">
            <MdOutlineArrowBack className="text-[#B3B3B3]" size={24} />
          </button>
          <button className="next border-[#B3B3B3] border text-[#B3B3B3] p-2 rounded-full cursor-pointer" aria-label="Go to next card">
