      ...
      <div className="grid grid-cols-2 w-[90%] md:w-full md:grid-cols-3 max-w-4xl mx-auto ">
        {donationOptions.map((item) => (
          ...
          >
            ...
            {/* Description */}
            <p className="text-[#777777] text-center md:text-start text-[10px] md:text-sm mt-2 md:h-10  font-inter group-hover:text-white transition-all duration-300 font-medium">
              {item.description}
            </p>
            ...
            <Link
              href={item.link}
              className="mt-4 inline-flex items-center justify-center px-6 py-3 rounded-full text-[14px] font-inter text-white font-bold bg-[#28A745] 
             hover:bg-white hover:text-[#28A745] transition-all duration-300 min-h-[44px] min-w-[44px] shadow-sm"
            >
