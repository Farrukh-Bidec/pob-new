...
const ZakatImpact = ({ section_6 }) => {
  ...
  //   {
  //     id: 1,
  //     image: "/hardship.webp", // Replace with your actual image path
  //     title: "From Hardship to Entrepreneurship",
  //     description: "It is a long established fact that a reader will be distracted.",
  //   },
  //   {
  //     id: 2,
  //     image: "/book.webp", // Replace with your actual image path
  //     title: "Educating the Future",
  //     description: "It is a long established fact that a reader will be distracted.",
  //   },
  //   {
  //     id: 3,
  //     image: "/mind.webp", // Replace with your actual image path
  //     title: "Ensuring Health & Well-being",
  //     description: "It is a long established fact that a reader will be distracted.",
  //   },
  //   {
  //     id: 4,
  //     image: "/power.webp", // Replace with your actual image path
          ...
          <div key={index} className="flex flex-col items-center text-center">
            <div className="p-3 mb-4 bg-green-600 rounded-lg">
              <img
                ...
                alt={item?.alt_text || item?.title || "Zakat Impact"}
                className="w-10 h-10"
              />
            </div>
