...
export async function generateMetadata() {
  ...
  return {
    ...
    openGraph: {
      ...
      type: "website",
      images: academics?.pagesSeoDetail?.meta_image
        ? [
            {
              url: `https://pobtrust.com${academics.pagesSeoDetail.meta_image}`,
              width: 1200,
              height: 630,
              alt: academics?.pagesSeoDetail?.meta_title || "Academics Image",
            },
          ]
        : [],
    },
    twitter: {
      ...
      description: academics?.pagesSeoDetail?.meta_description,
      images: academics?.pagesSeoDetail?.meta_image
        ? [`https://pobtrust.com${academics.pagesSeoDetail.meta_image}`]
        : [],
    },
