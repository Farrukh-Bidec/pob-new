...
export async function generateMetadata() {
  ...
  return {
    ...
    alternates: {
      canonical: `https://pobtrust.com${about?.aboutUsPageSeo?.canonical_url}` || undefined,
    },
    openGraph: {
      title: about?.aboutUsPageSeo?.meta_title,
      description: about?.aboutUsPageSeo?.meta_description,
      type: "website",
      images: about?.aboutUsPageSeo?.meta_image
        ? [
            {
              url: `https://pobtrust.com${about.aboutUsPageSeo.meta_image}`,
              width: 1200,
              height: 630,
              alt: about?.aboutUsPageSeo?.meta_title || "About Us Image",
            },
          ]
        : [],
    },
    twitter: {
      ...
      description: about?.aboutUsPageSeo?.meta_description,
      images: about?.aboutUsPageSeo?.meta_image
        ? [`https://pobtrust.com${about.aboutUsPageSeo.meta_image}`]
        : [],
    },
