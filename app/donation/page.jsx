...
//       <ArabicVerse
//         img01="/arabicVerse.webp"
//         img02="/arabicVerse.webp"
...
export async function generateMetadata() {
  const waqfData = await fetchData({
    url: "donation-page/show-data",
    slug: "donation/",
  });
  ...
  return {
    title: waqfData?.donationPageSeo?.meta_title || "Donation Page",
    description: waqfData?.donationPageSeo?.meta_description || "Learn about Donation with POB Trust",
    keywords: waqfData?.donationPageSeo?.focus_keyword || undefined,
    alternates: { canonical: `https://pobtrust.com${waqfData?.donationPageSeo?.canonical_url}` },
    openGraph: {
      title: waqfData?.donationPageSeo?.meta_title,
      description: waqfData?.donationPageSeo?.meta_description,
      type: "website",
      images: waqfData?.donationPageSeo?.meta_image
        ? [
          {
            url: `https://pobtrust.com${waqfData.donationPageSeo.meta_image}`,
            width: 1200,
            height: 630,
            alt: waqfData?.donationPageSeo?.meta_title || "Donation Image",
          },
        ]
        : [],
    },
    twitter: {
      ...
      description: waqfData?.donationPageSeo?.meta_description,
      images: waqfData?.donationPageSeo?.meta_image
        ? [`https://pobtrust.com${waqfData.donationPageSeo.meta_image}`]
        : [],
    },
    other: waqfData?.donationPageSeo?.schema
      ? [
        {
          tagName: "script",
          type: "application/ld+json",
          innerHTML: waqfData.donationPageSeo.schema,
        },
      ]
      : [],
  };
  ...
  return (
    <div className="pt-20 md:pt-32">
      ...
      <ArabicVerse
        img01="/arabicVerse.webp"
        img02="/arabicVerse.webp"
        alt="Quran verse from Surah Al-Ahzab (33:35) describing the qualities of believing men and women and the reward for them."
        text="Indeed, the men who practice charity and the women who practice charity and [they who] have loaned Allah a goodly loan - it will be multiplied for them, and they will have a noble reward."
      />
      ...
      // handleDonateClick={() => {
      //   ("Redirect to donation form or page");
      // }}
      />
