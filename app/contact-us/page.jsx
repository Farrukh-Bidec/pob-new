...
export async function generateMetadata() {
  ...
  return {
    ...
    alternates: { canonical: `https://pobtrust.com${contactData?.pagesSeoDetail?.canonical_url}` },
    openGraph: {
      title: contactData?.pagesSeoDetail?.meta_title,
      description: contactData?.pagesSeoDetail?.meta_description,
      type: "website",
      images: contactData?.pagesSeoDetail?.meta_image
        ? [
            {
              url: `https://pobtrust.com${contactData.pagesSeoDetail.meta_image}`,
              width: 1200,
              height: 630,
              alt: contactData?.pagesSeoDetail?.meta_title || "Contact Image",
            },
          ]
        : [],
    },
    twitter: {
      ...
      description: contactData?.pagesSeoDetail?.meta_description,
      images: contactData?.pagesSeoDetail?.meta_image
        ? [`https://pobtrust.com${contactData.pagesSeoDetail.meta_image}`]
        : [],
    },
